...
```powershell
Copy-Item .build\publish\win-x64\Haytrix.exe C:\Windows\System32\Haytrix.scr -Force
...
Right-click `C:\Windows\System32\Haytrix.scr` → **Install**
...
```powershell
reg add "HKCU\Control Panel\Desktop" /v SCRNSAVE.EXE     /t REG_SZ /d "C:\Windows\System32\Haytrix.scr" /f
...
```powershell
Remove-Item C:\Windows\System32\Haytrix.scr -Force
Remove-Item C:\Windows\System32\WebView2Loader.dll -Force
Remove-Item $env:TEMP\HaytrixWebView2 -Recurse -Force
```
